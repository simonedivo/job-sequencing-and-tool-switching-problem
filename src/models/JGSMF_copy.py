...
class JGSMFModel:
    ...
    def setup_constraints(self):
        ...
        for t in self.tools:
            for k in self.bins:
                self.model.addConstr(self.f[k-1,k,t] + self.f[self.REPO,k,t] == self.f[k,k+1,t] + self.f[k,self.DETACHED,t] + self.f[k,self.REPO,t], name=f"FlowConservation(3g)")
...
#tools = [1, 2, 3]
#magazine_capacity = 2
#job_tools_requirements = {1: [1, 2], 2: [2], 3: [3], 4: [1, 3]}
